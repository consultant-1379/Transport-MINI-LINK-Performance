...
#
# ********************************************************************
# Name    : ActiveVisualLineChart.py
# Date    : 21/07/2022
# Revision: 1.0
# Purpose : Sets document property flag value to determine if linechart is currently active visualization.
#
...
if vis.TypeId == VisualTypeIdentifiers.LineChart:
    Document.Properties['ActiveVisualReference'] = 'linechart'